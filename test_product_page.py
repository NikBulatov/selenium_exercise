...
# Реализация фикстуры для ProductPage
# @pytest.mark.login
# class TestLoginFromProductPage(ProductPage):
#     @pytest.fixture(scope="function", autouse=True)
#     def setup(self):
#         """
#         Вообще говоря манипулировать браузером в сетапе и уж тем более что-то там проверять — это плохая практика,
#         лучше так не делать без особой необходимости. Здесь этот пример исключительно в учебных целях,
#         чтобы вы попробовали писать сетапы для тестов.
#         В реальной жизни мы реализовали бы все эти манипуляции с помощью API или напрямую через базу данных.
#         """
